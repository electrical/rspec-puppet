...
# c.default_manifest = File.join(File.dirname(File.expand_path(__FILE__)), 'fixtures', 'manifests', 'site.pp')
#  c.confdir = File.join(File.dirname(File.expand_path(__FILE__)), 'fixtures')
end
